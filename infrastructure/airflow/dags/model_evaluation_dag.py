...
def evaluate_finetuned_model_on_tweets(ds, **kwargs):
    ...
    fine_tuned_model = Variable.get(
        ...
        "rayenx2/roberta-sentiment-finetuned"
    )
...
def generate_comparison_report(ds, **kwargs):
    ...
    try:
        ...
        finetuned_model_query = 'model_accuracy{model_name="rayenx2/roberta-sentiment-finetuned",dataset="tweet_eval"}'
        finetuned_amazon_query = 'model_accuracy{model_name="rayenx2/roberta-sentiment-finetuned",dataset="mteb/amazon_reviews_multi"}'
