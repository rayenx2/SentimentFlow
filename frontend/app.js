...
function renderSingleResult(data) {
  ...
  document.getElementById('sentiment-icon').innerHTML = sentimentDotSVG(sentimentColor(sentiment));
...
function sentimentDotSVG(color) {
  return `<svg width="14" height="14" viewBox="0 0 14 14" style="display:inline-block;vertical-align:-2px"><circle cx="7" cy="7" r="7" fill="${color}"/></svg>`;
}
