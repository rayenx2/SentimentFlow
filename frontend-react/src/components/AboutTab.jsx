        ...
        <div className={`${styles.card} ${styles.wide}`}>
          ...
          <div className={styles.author}>
            ...
            <div className={styles.authorLinks}>
              <a href="https://github.com/Hamilas" target="_blank" rel="noreferrer" className={styles.link}>
              ...
              <a href="https://www.linkedin.com/in/lassoued-rayen/" target="_blank" rel="noreferrer" className={styles.link}>
