...
async def get_ui(request: Request):
    ...
    <body>
        ...
        <footer style="margin-top: 40px; border-top: 1px solid #eee; padding-top: 10px; color: #666; font-size: 0.85em;">
            Rayen Lassoued &middot; <a href="https://github.com/rayenx2">github.com/rayenx2</a> &middot;
            <a href="https://linkedin.com/in/Rayen-Lassoued">linkedin.com/in/Rayen-Lassoued</a>
        </footer>
