...
async def lifespan(app: FastAPI):
    """Application lifespan — loads model on startup, cleans up on shutdown."""
    logger.info("Starting up SentimentFlow API")
    ...
    logger.info("Shutting down SentimentFlow API")
...
async def get_ui(request: Request):
    ...
    <html>
    <head>
        <title>SentimentFlow — Sentiment Analysis</title>
        <style>
    ...
    <body>
        <h1>SentimentFlow — Sentiment Analysis Demo</h1>
        ...
        <footer style="margin-top: 40px; border-top: 1px solid #eee; padding-top: 10px; color: #666; font-size: 0.85em;">
            Rayen Lassoued &middot; <a href="https://github.com/Hamilas">github.com/Hamilas</a> &middot;
            <a href="https://www.linkedin.com/in/lassoued-rayen/">https://www.linkedin.com/in/lassoued-rayen/</a>
        </footer>
